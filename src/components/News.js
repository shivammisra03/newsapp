...
export class News extends Component {
    ...
    async componentDidMount() {
        let url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=97b727ed6f9f4c4c96f60ae2a43669f7&page=1&pageSize=${this.props.pageSize}`;
    ...
    handlePrevChange = async () => {
        let url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=97b727ed6f9f4c4c96f60ae2a43669f7&page=${this.state.page - 1}&pageSize=${this.props.pageSize}`;
        this.setState({ loading: true })
        let data = await fetch(url);
        let parsedData = await data.json()
        this.setState({
